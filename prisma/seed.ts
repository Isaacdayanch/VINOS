...
async function main() {
  ...
  console.log("Creando pedido P001 y sus entradas...");
  ...
  console.log("Registrando el pago de mercancía del pedido P001...");
  ...
  console.log("Registrando salidas manuales (muestras y consumo interno)...");
  ...
  console.log("Listo. Datos reales importados.");
}
